const SortIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    <svg
...
const EyeIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
...
const FilterIcon = ({
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path fill={fill} d="M7 11h10v2H7zM4 7h16v2H4zm6 8h4v2h-4z" />
    </svg>
  );
};
const StackIcon = ({
...
const ArrowIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const CloseIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const RefreshIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const UpArrowIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      viewBox="0 0 40 40"
    >
      <path fill={fill} d="M4.659 28.167h30.682L20 7.833z" />
    </svg>
  );
};
